...
\vfill
\begin{center}
\textbf{The up to date version of this tutorial is available \href{https://github.com/adrientaudiere/cati/blob/Package-cati/tutorials/vignette_Darwin_finches/vignette.pdf}{here}.}
\end{center}
...
This is the end of the tutorial. The up to date version of this tutorial is available \href{https://github.com/adrientaudiere/cati/blob/Package-cati/tutorials/vignette_Darwin_finches/vignette.pdf}{here}.
