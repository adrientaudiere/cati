...
<<No_Filter_plots, fig.cap = "Distribution of trait values for one randomization without filtering: (a) Community-level trait distributions for the trait a (normal distribution); (b) Community-level trait distributions for the trait b (uniform distribution); (c) Species' trait distributions for the trait a; (d) Species' trait distributions for the trait b", crop = TRUE>>= 
par(mfrow=c(2, 2))
...
We test for the \textbf{alpha error} of global p-values in the same way as local p-values. We plot the ordered mean \footnote{mean of the \Sexpr{Ncom} communities values} standardized effect size (SES)\footnote{compute as (the observed value - the mean value among simulation) / the standard error among simulations} and the 95\% confidence interval in grey. 
...
<<typical_result_internal_filtering1, fig.cap = "Distribution of trait values for one randomization with internal filtering: (a) Community-level trait distributions for the trait a (normal distribution); (b) Community-level trait distributions for the trait b (uniform distribution); (c) Species' trait distributions for the trait a; (d) Species' trait distributions for the trait b", crop = TRUE>>= 
par(mfrow=c(2, 2))
...
<<typical_results_external_filtering1, fig.cap = "Distribution of trait values for one randomization with external filtering: (a) Community-level trait distributions for the trait a (normal distribution); (b) Community-level trait distributions for the trait b (uniform distribution); (c) Species' trait distributions for the trait a; (d) Species' trait distributions for the trait b", crop = TRUE>>= 
par(mfrow=c(2, 2))
...
<<typical_results_external_filtering2, fig.height = 8, fig.cap = "Results of T-statistics for two randomization with contrasted strength of external filtering: $T_{IP/IC}$ in red, $T_{IC/IR}$ in purple and $T_{PC/PR}$ in green. (a) Lower strength of external filtering and (b) higher strength of external filtering.", crop = TRUE>>= 
par(mfrow=c(2, 1))
...
@
  ...
  \subsection{Results}
<<InEx_Filter_plots, fig.cap = "Distribution of trait values for one randomization with both internal and external filter: (a) Community-level trait distributions for the trait a (normal distribution); (b) Community-level trait distributions for the trait b (uniform distribution); (c) Species' trait distributions for the trait a; (d) Species' trait distributions for the trait b", crop = TRUE>>= 
par(mfrow=c(2, 2))
