...
\hlkwa{for}\hlstd{(n} \hlkwa{in} \hlnum{1}\hlopt{:}\hlstd{npermut)\{}\hlcom{#for each permutation}
 ...
 \hlcom{# Draw communities using lognormal distribution of abundances }
 ...
 \hlkwa{for}\hlstd{(c} \hlkwa{in} \hlnum{1}\hlopt{:} \hlstd{Ncom)\{}
  \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind} \hlopt{/} \hlstd{Ncom,}
                                \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),} \hlkwc{replace} \hlstd{= T))}

  \hlstd{ex.com1[c, sp} \hlopt{%in%} \hlkwd{names}\hlstd{(ex.com.interm)]} \hlkwb{<-} \hlstd{ex.com.interm}

  \hlstd{ex.sp1} \hlkwb{<-} \hlkwd{c}\hlstd{(ex.sp1,} \hlkwd{rep}\hlstd{(sp,} \hlkwc{times} \hlstd{= ex.com1[c,]))}
 \hlstd{\}}
 \hlstd{ex.indplot1} \hlkwb{<-} \hlkwd{sort}\hlstd{(}\hlkwd{as.factor}\hlstd{(}\hlkwd{rep}\hlstd{(com, Nind} \hlopt{/} \hlstd{Ncom)))}
...
In that case we have one p-value by T-statistics by traits for each of the 3 permutations.
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
...
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
 ...
 \hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:} \hlstd{Ncom)\{}
  ...
  \hlstd{ex.com2[i, sp}\hlopt{%in%} \hlkwd{names}\hlstd{(ex.com.interm)]} \hlkwb{<-} \hlstd{ex.com.interm}
  \hlstd{ex.sp2} \hlkwb{<-} \hlkwd{c}\hlstd{(ex.sp2,} \hlkwd{rep}\hlstd{(sp,} \hlkwc{times} \hlstd{= ex.com2[i,]))}
 \hlstd{\}}

 \hlstd{ex.indplot2} \hlkwb{<-} \hlkwd{sort}\hlstd{(}\hlkwd{as.factor}\hlstd{(}\hlkwd{rep}\hlstd{(com, Nind}\hlopt{/}\hlstd{Ncom)))}

<<<<<<< HEAD
 \hlcom{# Defining trait mean and sd per species }
=======
...
=======
Let's see the result for one randomization. We can plot the distribution of traits values within species and/or communities thanks to the function \texttt{plotDistri} (Fig. \ref{fig:typical_result_internal_filtering1}). 
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
...
=======
We can verify the consistency of our results by plotting SES values against the modeled parameters values (Fig. \ref{fig:Internal_filter_Results_plots_modeled_param}). 
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
...
\hlkwa{for}\hlstd{(n} \hlkwa{in} \hlnum{1}\hlopt{:}\hlstd{nperm)\{}\hlcom{#for each permutation}
 ...
 \hlstd{ex.com3} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{0}\hlstd{,} \hlkwc{nrow} \hlstd{= Ncom,} \hlkwc{ncol} \hlstd{= Nsp)}
 \hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:} \hlnum{10}\hlstd{)\{}
  \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind}\hlopt{/}\hlstd{Ncom,} \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),} \hlkwc{replace} \hlstd{= T))}
  \hlstd{ex.com3[i, sp}\hlopt{%in%} \hlkwd{names}\hlstd{(ex.com.interm)]} \hlkwb{<-} \hlstd{ex.com.interm}
  \hlstd{ex.sp3} \hlkwb{<-} \hlkwd{c}\hlstd{(ex.sp3,} \hlkwd{rep}\hlstd{(sp,} \hlkwc{times} \hlstd{= ex.com3[i,]))}
 \hlstd{\}}

 \hlstd{ex.indplot3} \hlkwb{<-} \hlkwd{sort}\hlstd{(}\hlkwd{as.factor}\hlstd{(}\hlkwd{rep}\hlstd{(com, Nind}\hlopt{/}\hlstd{Ncom)))}

<<<<<<< HEAD
 \hlcom{#Defining mean and sd for each community}
=======
...
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
 ...
 \hlstd{ex.traits3} \hlkwb{<-} \hlkwd{array}\hlstd{(}\hlnum{NA}\hlstd{,} \hlkwc{dim} \hlstd{=} \hlkwd{c}\hlstd{(Nind,} \hlnum{2}\hlstd{))}
...
<<<<<<< HEAD
\caption[Global $T_{PC/PR}$ SES and initial parameter values]{Global $T_{PC/PR}$ SES and initial parameter values: Standardized effect size of $T_{PC/PR}$ as a function of the strength of external filtering defined as the ratio of the inital range parameter by the initial standard error parameter. Colored area represents the mean confidence interval of SES values ($alpha = 0.95$). Trait a (normal) in black and trait b (uniform) in purple.}\label{fig:External_filter_Results_plots_initial_param2}
=======
...
<<<<<<< HEAD
\hlkwd{points}\hlstd{(meanSES.3glob.norm_Ticir} \hlopt{~} \hlstd{init_param,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.5}\hlstd{),}
       \hlkwc{cex} \hlstd{=} \hlnum{1.2}\hlstd{)}
\hlstd{lm.norm} \hlkwb{<-} \hlkwd{lm}\hlstd{(meanSES.3glob.norm_Ticir} \hlopt{~} \hlkwd{log}\hlstd{(init_param))}
\hlstd{lm.norm_conf} \hlkwb{<-} \hlkwd{confint}\hlstd{(lm.norm,} \hlkwc{level} \hlstd{=} \hlnum{0.90}\hlstd{)}
\hlkwd{curve}\hlstd{(lm.norm}\hlopt{$}\hlstd{coef[}\hlnum{1}\hlstd{]} \hlopt{+} \hlkwd{log}\hlstd{(x)} \hlopt{*} \hlstd{(lm.norm}\hlopt{$}\hlstd{coef[}\hlnum{2}\hlstd{]),} \hlkwc{add} \hlstd{= T,} \hlkwc{lwd} \hlstd{=} \hlnum{3}\hlstd{,}
      \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{))}
\hlkwd{curve}\hlstd{(lm.norm_conf[}\hlnum{1}\hlstd{,} \hlnum{1}\hlstd{]} \hlopt{+} \hlkwd{log}\hlstd{(x)} \hlopt{*} \hlstd{lm.norm_conf[}\hlnum{2}\hlstd{,} \hlnum{1}\hlstd{],} \hlkwc{add} \hlstd{= T,} \hlkwc{lty} \hlstd{=} \hlnum{2}\hlstd{,}
      \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{))}
\hlkwd{curve}\hlstd{(lm.norm_conf[}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{]} \hlopt{+} \hlkwd{log}\hlstd{(x)} \hlopt{*} \hlstd{lm.norm_conf[}\hlnum{2}\hlstd{,} \hlnum{2}\hlstd{],} \hlkwc{add} \hlstd{= T,} \hlkwc{lty} \hlstd{=} \hlnum{2}\hlstd{,}
      \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{))}

\hlkwd{points}\hlstd{(meanSES.3glob.uni_Ticir} \hlopt{~} \hlstd{init_param,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0.5}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0.5}\hlstd{),}
       \hlkwc{cex} \hlstd{=} \hlnum{1.2}\hlstd{)}
...
\hlkwd{rect}\hlstd{(}\hlopt{-}\hlnum{1}\hlstd{,} \hlkwd{mean}\hlstd{(}\hlkwd{c}\hlstd{(SES.inf.MEAN.uni_Ticir, meanSES.INF_glob.uni_Ticir),} \hlkwc{na.rm} \hlstd{= T),}
     \hlkwd{max}\hlstd{(init_param),} \hlnum{10}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0.5}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0.3}\hlstd{),} \hlkwc{border} \hlstd{=} \hlnum{NA}\hlstd{)}

\hlkwd{rect}\hlstd{(}\hlopt{-}\hlnum{1}\hlstd{,} \hlkwd{mean}\hlstd{(}\hlkwd{c}\hlstd{(SES.inf.MEAN.norm_Ticir, meanSES.INF_glob.norm_Ticir),} \hlkwc{na.rm} \hlstd{= T),}
     \hlkwd{max}\hlstd{(init_param)} \hlopt{+} \hlnum{10}\hlstd{,} \hlnum{10}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.3}\hlstd{),} \hlkwc{border} \hlstd{=} \hlnum{NA}\hlstd{)}
=======
...
<<<<<<< HEAD
\hlkwd{points}\hlstd{(meanSES.3glob.norm_Tpcpr} \hlopt{~} \hlstd{init_param,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.5}\hlstd{),}
       \hlkwc{cex} \hlstd{=} \hlnum{1.2}\hlstd{)}
...
\hlkwd{points}\hlstd{(meanSES.3glob.uni_Tpcpr} \hlopt{~} \hlstd{init_param,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0.5}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0.5}\hlstd{),}
       \hlkwc{cex} \hlstd{=} \hlnum{1.2}\hlstd{)}
...
\hlkwd{rect}\hlstd{(}\hlopt{-}\hlnum{1}\hlstd{,} \hlkwd{mean}\hlstd{(}\hlkwd{c}\hlstd{(SES.inf.MEAN.uni_Tpcpr, meanSES.INF_glob.uni_Tpcpr),} \hlkwc{na.rm} \hlstd{= T),}
     \hlkwd{max}\hlstd{(init_param),} \hlnum{10}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0.5}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0.3}\hlstd{),} \hlkwc{border} \hlstd{=} \hlnum{NA}\hlstd{)}

\hlkwd{rect}\hlstd{(}\hlopt{-}\hlnum{1}\hlstd{,} \hlkwd{mean}\hlstd{(}\hlkwd{c}\hlstd{(SES.inf.MEAN.norm_Tpcpr, meanSES.INF_glob.norm_Tpcpr),} \hlkwc{na.rm} \hlstd{= T),}
     \hlkwd{max}\hlstd{(init_param)} \hlopt{+} \hlnum{10}\hlstd{,} \hlnum{10}\hlstd{,} \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.3}\hlstd{),} \hlkwc{border} \hlstd{=} \hlnum{NA}\hlstd{)}
=======
...
\hlstd{ex.com4} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{0}\hlstd{,} \hlkwc{nrow} \hlstd{= Ncom,} \hlkwc{ncol} \hlstd{= Nsp)}
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:} \hlnum{10}\hlstd{)\{}
<<<<<<< HEAD
 \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind}\hlopt{/}\hlstd{Ncom,} \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),}
                               \hlkwc{replace} \hlstd{= T))}
=======
 \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind}\hlopt{/}\hlstd{Ncom,} \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),} \hlkwc{replace} \hlstd{= T))}
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
 \hlstd{ex.com4[i, sp}\hlopt{%in%} \hlkwd{names}\hlstd{(ex.com.interm)]} \hlkwb{<-} \hlstd{ex.com.interm}
 \hlstd{ex.sp4} \hlkwb{<-} \hlkwd{c}\hlstd{(ex.sp4,} \hlkwd{rep}\hlstd{(sp,} \hlkwc{times} \hlstd{= ex.com4[i,]))}
\hlstd{\}}

\hlstd{ex.indplot4} \hlkwb{<-} \hlkwd{sort}\hlstd{(}\hlkwd{as.factor}\hlstd{(}\hlkwd{rep}\hlstd{(com, Nind}\hlopt{/}\hlstd{Ncom)))}


<<<<<<< HEAD
\hlcom{#Defining trait mean and sd for each species }
=======
\hlcom{#Defining traits mean and sd by species }
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
\hlstd{mean_mean.param.interm} \hlkwb{<-} \hlkwd{seq}\hlstd{(max.value_traits} \hlopt{-} \hlstd{param_DIST_between_MEAN[n],}
...
<<<<<<< HEAD
\caption[Results of T-statistics with both internal and external filtering]{Results of T-statistics with both internal and external filtering: $T_{IP/IC}$ in red, $T_{IC/IR}$ in purple and $T_{PC/PR}$ in green. (a) Lower strength of filtering (b) higher strength of filtering.}\label{fig:InEx_Filter_plots_Tstats}
=======
...
\hlstd{sdlog}
\hlkwd{table}\hlstd{(com)}
\hlkwd{table}\hlstd{(sp)}
...
<<<<<<< HEAD
 ...
 \hlstd{ex.com5} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{0}\hlstd{,} \hlkwc{nrow} \hlstd{= Ncom,} \hlkwc{ncol} \hlstd{= Nsp)}
 \hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:} \hlstd{Ncom)\{}
 \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind}\hlopt{/}\hlstd{Ncom,} \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),}
                               \hlkwc{replace} \hlstd{= T))}
=======
 ...
 \hlstd{ex.com.interm} \hlkwb{<-} \hlkwd{table}\hlstd{(}\hlkwd{sample}\hlstd{(sp,} \hlkwc{size} \hlstd{= Nind}\hlopt{/}\hlstd{Ncom,} \hlkwc{prob} \hlstd{=} \hlkwd{rlnorm}\hlstd{(Nsp,} \hlnum{0}\hlstd{, sdlog),} \hlkwc{replace} \hlstd{= T))}
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
 \hlstd{ex.com5[i, sp}\hlopt{%in%} \hlkwd{names}\hlstd{(ex.com.interm)]} \hlkwb{<-} \hlstd{ex.com.interm}
...
\hlstd{sdlog}
<<<<<<< HEAD
\hlstd{turnover_strength} \hlkwb{<-} \hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{0.1}\hlstd{,} \hlnum{0.25}\hlstd{,} \hlnum{0.5}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{2}\hlstd{,} \hlnum{5}\hlstd{,} \hlnum{7.5}\hlstd{,} \hlnum{10}\hlstd{,} \hlnum{12.5}\hlstd{,} \hlnum{15}\hlstd{),}
=======
...
<<<<<<< HEAD
\hlkwd{plot}\hlstd{(res.decompCTRE_toymodel[[}\hlkwd{length}\hlstd{(res.decompCTRE_toymodel)]]}\hlopt{$}\hlstd{X2)}
=======
...
<<<<<<< HEAD
\caption[Decomposition of the variation in community trait composition for two contrasted cases]{Decomposition of the variation in community trait composition for two contrasted cases: on the left almost all the variation is due to turnover whereas on the rigth case intraspecific variation explain most of the variation.}\label{fig:decompCTRE_plot1}
=======
...
\begin{alltt}
<<<<<<< HEAD
\hlstd{res.sim.decompCTRE_toymodel} \hlkwb{<-} \hlkwd{unlist}\hlstd{(}\hlkwd{lapply}\hlstd{(res.decompCTRE_toymodel,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)}
                                              \hlstd{x}\hlopt{$}\hlstd{X2}\hlopt{$}\hlstd{RelSumSq[}\hlnum{1}\hlstd{]))}
\hlkwd{plot}\hlstd{(res.sim.decompCTRE_toymodel,} \hlopt{-}\hlstd{turnover_strength,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,}
     \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.5}\hlstd{),}
=======
\hlstd{res.simu.decompCTRE_toymodel} \hlkwb{<-} \hlkwd{unlist}\hlstd{(}\hlkwd{lapply}\hlstd{(res.decompCTRE_toymodel,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)}
                                              \hlstd{x}\hlopt{$}\hlstd{X2}\hlopt{$}\hlstd{RelSumSq[}\hlnum{1}\hlstd{]))}
\hlkwd{plot}\hlstd{(res.simu.decompCTRE_toymodel,} \hlopt{-}\hlstd{turnover_strength,} \hlkwc{pch} \hlstd{=} \hlnum{16}\hlstd{,}
     \hlkwc{col} \hlstd{=} \hlkwd{rgb}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{0.5}\hlstd{),} \hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{10}\hlstd{),}
>>>>>>> 87c743725b1abcf328762b9a9213851f787c640d
